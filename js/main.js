// Generated Phase-1 loader preserving original script execution order and types.
const __inlineScripts = [
  {type: '', id: 'bpSafeDomHelpers', code: `
(function(){
...
for (const s of __inlineScripts) {
